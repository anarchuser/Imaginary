...
int main (int argc, char * argv[]) {
    ...
    LOG (INFO) << "Apply operations to original images";
    {
        ...
        std::cout << "resize_dims, 128 x 128" << std::endl;
        apply ([](Image const & image) { return original::resize_dims_l (image, 128, 128); });
    ...
    LOG (INFO) << "Apply operations to gray images";
    {
        ...
        //std::cout << "canny edge detection with average gray value as threshold" << std::endl;
        //APPLY (gray::threshold_l, -1);
